...
const [IsLoading, setIsLoading] = useState(false)
  ...
  {ApiError?<div className='w-1/2 mx-auto bg-red-700 text-white rounded-lg p-3 text-center'>{ApiError}</div>:null}
    <div className='my-5'>
      <h2 className='text-2xl font-bold text-emerald-600 mb-3'>Login Now</h2>
 ...
 {formik.errors.password}
      ...
      <Link to={"/resetPassword"}><span className='text-blue-600 underline'>reset your password</span></Link>
      </div>
      </form>
